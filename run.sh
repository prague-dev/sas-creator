...
echo '@include /apex/com.android.media/etc/seccomp_policy/crash_dump.arm64.policy' >> etc/seccomp_policy/mediaextractor.policy
echo '@include  /apex/com.android.media/etc/seccomp_policy/code_coverage.arm64.policy' >> etc/seccomp_policy/mediaextractor.policy
